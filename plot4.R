...
## Plot 4 -- Include all above CHARTs + Voltage in one PAGE
...
with(df, {
	...
	plot(datetime, Sub_metering_1, type="S", col="black", ylab="Energy sub metering", xlab="")
	points(df$datetime, df$Sub_metering_2, type="S", col="red")
	points(df$datetime, df$Sub_metering_3, type="S", col="blue")
	legend("topright", legend = c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), col=c("black","red","blue"), pch="__", bty="n", inset=0.08, yjust=0)
...
print("Execution completed -- plot3.R")
