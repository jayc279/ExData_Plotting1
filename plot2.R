...
## Plot 2
## Using 'type' we get VERTICAL LINES
## acknowledgements - ## https://www.learnbyexample.org/r-plot-function/
with(df, plot(datetime, Global_active_power, type="S", ylab="Global Active Power (kilowatts)", xlab=""))
...
print("Execution completed -- plot2.R")
